<template>
    ...
    <div class="container">
      <div class="row px-0 mx-0 justify-content-center align-items-center">
        <div class="block-44__logo-container">
          <img class="block-44__logo" src="/src/assets/imgs/logo.svg">
        </div>
        <ul class="block-44__list list-unstyled justify-content-center mb-0">
          ...
          <li class="block-44__li-1">
            <a href="#" class="block-44__link">Empresas</a>
          </li>
          <li class="block-44__li-1">
            <a href="#" class="block-44__link">Otros Productos</a>
          </li>
          <li class="block-44__li-1">
            <a href="#" class="block-44__link">Cuenta</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row flex-column flex-md-row px-2 justify-content-center">
        ...
        <p class="block-41__copyrights">&copy; 2020 TicsOaxca. All Rights Reserved.</p>
      </div>
    </div>
  </div>
